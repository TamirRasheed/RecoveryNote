...
//Calling Test Functions Bellow This Line
 function test() {
     /*
     Create a different user for each test, will not allow duplicate
     usernames
     */
...
//test()
postProduct('My product','A description',30.00,'https://res.cloudinary.com/dy6ekyp9m/image/upload/v1636416716/ftyob6s57ibosakm8qnf.png','Biology','NotJoel');