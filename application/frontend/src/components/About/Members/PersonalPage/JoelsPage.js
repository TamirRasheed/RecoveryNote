      ...
      <Grid container spacing={6} alignItems='center'>
        ...
        <Box clone order={{ xs: 3, sm: 2 }} className={textCenter}>
          <Grid item xs={12} sm={6}>
            ...
            <Typography>
            What can I really say about myself. I am a man of few words... well that’s a lie, I actually talk a lot. 
            I was born and raised in the San Francisco Bay Area, because of this many people call me a native unicorn... 
            I call myself “not a hipster”. At SFSU, I am currently in my senior year looking to graduate in the Spring of 2022 with a degree in Computer Science. 
            The language I have done the most work in is Java but also feel comfortable working in Python and to an extent C++.
